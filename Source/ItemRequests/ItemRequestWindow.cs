...
namespace ItemRequests
{
    public class ItemRequestWindow : Window
    {
        ...
        private readonly List<ThingEntry> allRequestableItems = new();
        ...
        private readonly List<ThingEntry> filteredRequestableItems = new();
        private readonly Map map;
        private readonly Pawn negotiator;
        private readonly RequestSession requestSession;
        private readonly HashSet<ThingDef> stuffFilterSet = new();
        ...
        private void DrawFilterDropdowns(Rect rectArea)
        {
            ...
            {
                new("IR.ItemRequestWindow.FilterAll".Translate(), () =>
                {
        ...
        private void DrawTradeableContent(Rect mainRect)
        {
            ...
            var cumulativeContentHeight = 6f + (filteredRequestableItems.Count * 30f);
            ...
            for (var i = 0; i < filteredRequestableItems.Count; i++)
            {
                var counter = i;
                if (y > bottom && y < top)
                {
