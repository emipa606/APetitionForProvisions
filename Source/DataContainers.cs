...
namespace ItemRequests
{
    public class ItemTable
    {
        ...
        protected Action<ThingDef> doubleClickAction = null;
        protected Action<ThingDef> selectedAction = null;
        protected Func<ThingDef, bool> enabledFunc = (ThingDef) => { return true; };
        protected Column sortedColumn = null;
        protected int sortDirection = 1;
        protected ThingDef scrollTo;
        public class RowGroup
        {
            public string Label;
            public IEnumerable<ThingDef> Rows;
            public RowGroup()
            {
            }
            public RowGroup(string label, IEnumerable<ThingDef> rows)
            {
                this.Label = label;
                this.Rows = rows;
            }
        ...
        public class Column
        {
            ...
            public Action<ThingDef, Rect, Metadata> DrawAction = (ThingDef, Rect, Metadata) => { };
            public Func<ThingDef, float, Metadata, float> MeasureAction = null;
        ...
        //    }
        //}
        public Action<ThingDef> DoubleClickAction
        {
            get
            {
        ...
        public Action<ThingDef> SelectedAction
        {
            get
            {
        ...
        public Func<ThingDef, bool> RowEnabledFunc
        {
            get
            {
                return enabledFunc;
        ...
        public void ScrollTo(ThingDef row)
        {
            this.scrollTo = row;
        }
        ...
        public void Draw(IEnumerable<ThingDef> rows)
        {
        ...
        public void Draw(IEnumerable<RowGroup> rowGroups)
        {
            ...
            try
            {
                foreach (var group in rowGroups)
                {
                    ...
                    foreach (ThingDef row in group.Rows)
                    {
                        if (scrollTo != null && row == scrollTo)
                        {
                            scrollToCursorTop = cursor;
        ...
        protected float MeasureRow(ThingDef row, int index)
        {
            float rowHeight = 0;
            int columnIndex = 0;
        ...
        protected float DrawRow(float cursor, ThingDef row, int index)
        {
        ...
        //protected void DoScroll(IEnumerable<ThingDef> rows, ThingDef scrollTo)
        //{
        //    ResizeColumnHeights();
